...
public interface ClassRepository extends JpaRepository<ClassEntity, UUID> {
    ...
    @Query("select distinct c from ClassEntity c join fetch c.professors p where p = :professor")
    List<ClassEntity> findWithProfessors(@Param("professor") UserEntity professor);
}
